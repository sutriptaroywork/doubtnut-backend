...
class DescribeLiveStreamStateRequest extends AbstractModel {
    constructor(params) {
         ...
         * @type {string || null}
         */
        this.AppName = (typeof params.AppName !== 'undefined' && typeof params.AppName === 'string') ? params.AppName : null;
...
<li>Array length limit: 10.</li>
         * @type {Array.<string> || null}
         */
        this.DomainName = (typeof params.DomainName !== 'undefined' && typeof params.DomainName === 'string') ? params.DomainName : null;

        /**
         * Category ID set, which matches the categories of the specified IDs and all subcategories. Array length limit: 10.
         * @type {Array.<number> || null}
         */
        this.StreamName = (typeof params.StreamName !== 'undefined' && typeof params.StreamName === 'string') ? params.StreamName : null;
    }
