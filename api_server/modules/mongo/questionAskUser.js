...
function getDataFromMongo(query, sort) {
    return QuestionLogModel.find(query).sort(sort);
}

module.exports = {QuestionLogModel,isMatchUpdateMongo, findBySid, getDataFromMongo}
