...
router.route('/video-page-data-web/:id/:locale?').get(validate(paramValidation.answer.videoPageDataWeb), answerCtrl.videoPageDataWebLocalised)
router.route('/video-view-all/:id/:type').get(validate(paramValidation.answer.videoViewAll), answerCtrl.videoViewAll)
router.route('/set-like/:id').get(validate(paramValidation.answer.setLike), answerCtrl.setLike)
router.route('/set-view/:id').get(validate(paramValidation.answer.setView), answerCtrl.setView)
