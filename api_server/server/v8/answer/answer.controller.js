 ...
 * @Last modified time: 2019-07-11T19:17:05+05:30
 */
        ...
        if (typeof page !== 'undefined') {
            if (page === 'SC' || page === 'CC' || page === 'BROWSE_MC' || page === 'SEARCH_MC' || page === 'SEARCH_SC') {
                ...
                if (playlist_id === 'TRENDING') {
                    ...
                    let microconcept = question_id;
                    if (typeof question_id === 'number' && question_id) {
                        const temp = await Question.getMcIdbyQid(student_class, question_id, db.mysql.read);
                        microconcept = temp[0].microconcept;
                    }
                    promises.push(Question.getSimilarQuestionsByMcId(microconcept, limit, db.mysql.read));
                    ...
                    if (typeof question_id === 'number' && question_id) {
                        ...
                        microconcept = resPromise[0].doubt;
                    }
                    promises.push(Answer.getJeeAdvanceSimilarVideos(microconcept, limit, db.mysql.read));
                    ...
                    promises.push(Answer.getJeeMainsSimilarVideos(microconcept, limit, db.mysql.read));
                    ...
                    promises.push(Answer.getXSimilarVideos(microconcept, limit, db.mysql.read));
                    ...
                    promises.push(Answer.getXIISimilarVideos(microconcept, limit, db.mysql.read));
                    ...
                    promises.push(Answer.getNcertSimilarVideosUpdated(question_id, microconcept, limit, db.mysql.read));
