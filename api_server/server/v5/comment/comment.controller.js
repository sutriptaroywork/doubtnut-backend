 ...
 * @Last modified time: 2019-05-12T13:15:45+05:30
 */
    ...
    try {
      ...
      */
                ...
                if ((typeof req.body.entity_type !== 'undefined') && (typeof req.body.entity_id !== 'undefined')) {
                    ...
                    //   //get post details
                    //   let query = {_id:req.body.entity_id}
                    //   // //console.log(query)
                    ...
                    //     let title = req.user.student_username + " commented on your post."
                    //     let data ={id:req.body.entity_id,type:req.body.entity_type}
                    //     let message = "Check now!!"
                    //     Notification.sendNotification(result[0]['student_id'],event,title,message,null,data,admin,db)
                    //   }
