...
router.route('/update-answer-view').post(answerCtrlNew.updateAnswerViewBadReqFilter, validate(paramValidation.answer.updateAnswerView), authGuard, answerCtrl.updateAnswerView);
