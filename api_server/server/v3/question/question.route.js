...
router.route('/ask-web').post(compression(),questionCtrl.askWeb);
...
router.route('/get-match-results/:ocr_text').get(validate(paramValidation.question.getSearchResults),questionCtrl.getPrefixSearch);
...
router.route('/get-chapters-by-qid/:qid/:locale?').get(validate(paramValidation.question.getChaptersByQid),questionCtrl.getChaptersByQid);
