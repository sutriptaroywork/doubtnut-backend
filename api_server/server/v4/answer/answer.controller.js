            ...
            if (page === 'SC' || page === 'CC' || page === 'BROWSE_MC' || page === 'SEARCH_MC' || page === 'SEARCH_SC') {
                ...
                if (typeof mc_id !== 'undefined') {
                    ...
                    if (typeof language !== 'undefined') {
                        ...
                        for (let i = 0; i < similarQuestions.length; i++) {
                            if (language !== 'english') {
                                promises.push(QuestionContainer.getLocalisedQuestion(similarQuestions[i].question_id, language, db));
                ...
                if (playlist_id === 'TRENDING') {
                    ...
                    const resPromise = await Question.getByQuestionId(question_id, db.mysql.read);
                    doubt = resPromise[0].doubt;
                ...
                for (let i = 0; i < playlistData.length; i++) {
                    if (playlistData[i].question_id == question_id) {
                        ...
                        playlistData.splice(i, 1);// remove element at index i
                        break;
                    }
                }
                for (let i = 0; i < playlistData.length; i++) {
