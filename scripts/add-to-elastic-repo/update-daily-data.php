<?php
    ...
    try{
        ...
        $sql = "SELECT question_id, subject, is_answered, is_text_answered, ocr_text FROM questions WHERE (is_text_answered = 1 OR is_answered = 1) AND date(timestamp) = date(DATE_SUB(CURDATE(),INTERVAL 1 DAY)) AND is_skipped = 0 AND matched_question IS NULL  and student_id not in ('22','69','73','77','78','88','82','83','85','86')";
        // $sql = "SELECT question_id, subject, is_answered, is_text_answered, ocr_text FROM questions WHERE question_id=1";
        echo $sql;
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // $celery_local->PostTask('task1.tasks.upload_thumbnail', array($ocr_text, $question_id));
            }
        }
