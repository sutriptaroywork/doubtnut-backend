...
// const MongoClient = require("mongodb").MongoClientimages
// const mongoUrl = "mongodb://127.0.0.1:27017" 
// const mongoUrl = "mongodb://13.233.54.212:27017"
// let mongoDbClient = connectMongo()
let db

// function connectMongo() {
//     return new Promise((resolve, reject) => {
//         MongoClient.connect(mongoUrl,{useNewUrlParser: true},{useUnifiedTopology: true},function (err, c) {
//             console.log("Connected successfully to server")
       
//              mongoDbClient = c;
//             db = mongoDbClient.db("doubtnut")
...
function getAllTopics(mysql){
  ...
  let sql = "SELECT b.live_at, a.q_order, a.expert_name, b.subject, b.chapter, a.resource_reference FROM `structured_course_resources` AS a LEFT JOIN structured_course_details AS b ON a.structured_course_detail_id = b.id WHERE a.id >= 25 AND a.resource_type = 0 AND a.resource_reference > 100 AND a.class = 11"
...
async function main(mysql){
    try{
        ...
        for(let i=0; i<allTopics.length; i++)
        {
            ...
            let topic = allTopics[i].chapter.toUpperCase()
            ...
            {
              img_link = 'https://d10lpgp6xz60nq.cloudfront.net/images/banner-54.png'
            }
            else if(expert_name.includes('YAKSHU'))
            {
              img_link = 'https://d10lpgp6xz60nq.cloudfront.net/images/banner-55.png'
            }
            else
            {
              img_link = 'https://d10lpgp6xz60nq.cloudfront.net/images/banner-56.png'
            }
            let lectureText
            ...
            template =  template.replace('##', topic.toUpperCase())
            template =  template.replace('#:', lectureText.toUpperCase())
            ...
            // image_name = '3.png';
            screenshot_image = await page.screenshot({path:  './src/images/'+ image_name ,type:"png"})
