...
# Backup directory
DEST=/home/neil/Office/mongodump

# Tar file of backup directory
TAR=$DEST/../"mongo_"$TIME.tar
...
s3cmd put $TAR s3://$BUCKET/
#s3cmd put $TAR s3://$S3_BUCKET_NAME/$S3_BUCKET_PATH/mongodb-$HOSTNAME-$TIMESTAMP.tar
