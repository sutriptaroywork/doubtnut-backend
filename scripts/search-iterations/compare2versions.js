...
function getQuestionInfo(){
    ...
    let sql = "SELECT question_id, ocr_text, locale, is_trial  FROM `questions` WHERE `allocated_to` IN ('10401','10402','10403') and matched_question is not null  and student_id>100 ORDER BY `questions`.`question_id`  ASC LIMIT 2000"
    ...
    try {
      ...
      for(let i=0; i<=questionInfo.length;i++){
        ...
        if(question){
          ...
          if(resp13 && resp55 && resp13.toLowerCase() != resp55.toLowerCase()) {
